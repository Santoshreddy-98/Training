...
function Homepage() {
  ...
  var sEven = {
    borderRadius: "5px", padding: "3px", margin: "3px 0px", border: "2px solid green", background: "yellow"
  }
  var sOdd = {
    borderRadius: "5px", padding: "3px", margin: "3px 0px", border: "2px solid yellow", background: "yellowgreen"
  }
    ...
    <React.Fragment>
      ...
      <div style={{ postion: "absolute" }}>
        <div style={{ display: "flex",height:"60vh" }}>
          ...
          <div style={{ width: "25%",height:"50vh", }}>
            <h2 style={{ background: "powderblue", padding: "10px" }}>Latest Updates & News</h2>
            <marquee scrollamount="3" direction="up" >
              <div style={{ height: "300px", position: "relative" }}>
                {/* <img width="100%" src={k1}/>
                        <img width="100%" src={k2}/>
                        <img width="100%" src={k3}/>*/}
                <div style={sEven}>
                  <p>Hello welcome to latest updates</p>
                </div>
                <div style={sOdd}>
                  <p>Hello welcome to latest updates</p>
                </div>
